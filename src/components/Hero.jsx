...
function Hero() {
  return (
    <div className="h-screen bg-gradient-to-b from-black to-[#1a1a1a] text-white flex flex-col lg:flex-row justify-start items-center px-10">
      <div className="flex flex-col w-1/2 justify-start ml-[35px]">   
        <img
        ...
        />
        <div className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-center font-ooohbaby -rotate-12 inline-flex items-center whitespace-nowrap">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-5xl font-bold mt-4 sm:mt-6 md:mt-14 lg:mt-20">
