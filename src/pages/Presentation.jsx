...
function Presentation() {
  return (
    <section className="flex flex-col h-screen bg-black text-white font-[100] px-10 py-10">
      <h2 className="flex text-4xl font-bold justify-center w-full text-center">Présentation</h2>
    <div className="flex flex-col flex-grow md:flex-row h-full items-center justify-center">
      
      <div className="flex flex-col w-full lg:w-1/2">
      
        <p className="text-1xl sm:text-1xl md:text-1xl lg:text-1xl mt-4">
        ...
        <p className="text-1xl sm:text-1xl md:text-1xl lg:text-1xl mt-4 text-[#4FB3F4] font-bold font-[500]">
      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-1/2 lg:h-screen mt-8 lg:mt-0">
        ...
        <h3 className="text-2xl font-bold text-center mb-4">Téléchargez mon CV</h3>
        ...
        <a href="/public/cv-dorian.pdf" download="cv-dorian.pdf">
